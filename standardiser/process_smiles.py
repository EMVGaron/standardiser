...
'[Ru]','[Rh]','[Pd]','[Ag]','[Cd]','[Hf]','[Ta]','[W]','[Re]','[Os]','[Ir]','[Pt]','[Au]','[Sn]','[Pb]','[Hg]','[Cd+2]','[Cr+3]','[Cr+6]','[Sn+3]',
'[Mg++]','[Sb+3]','[Al+3]','[Ba++]','[Fe+3]','[Mg+2]','[B+3]','[B]','[Pb++]','[Zr-2]','[Mn+2]','[Mn+3]','[Sb]','[Ti+4]','[Fe++]','[Pd++]','[Rb+]',
'[Mg]','[Ca++]','[As]','[B]','[Si]','[Ge]','[Sb]','[Te]','[Po]']
